...
def votingPg(root,frame1,client_socket):
    ...
    Radiobutton(frame1, text = "Ravi\n\n(BE-CSE 3yr)", variable = vote, value = "bjp", indicator = 0, height = 4, width=15, command = lambda: voteCast(root,frame1,"bjp",client_socket)).grid(row = 2,column = 1)
    ...
    Radiobutton(frame1, text = "Bala\n\n(BE-CSE 3yr)", variable = vote, value = "cong", indicator = 0, height = 4, width=15, command = lambda: voteCast(root,frame1,"cong",client_socket)).grid(row = 3,column = 1)
    ...
    Radiobutton(frame1, text = "Ramya\n\n(BE-CSE 3yr)", variable = vote, value = "aap", indicator = 0, height = 4, width=15, command = lambda: voteCast(root,frame1,"aap",client_socket) ).grid(row = 4,column = 1)
    ...
    Radiobutton(frame1, text = "Ishwaraya\n\n(BE-CSE 3yr)", variable = vote, value = "ss", indicator = 0, height = 4, width=15, command = lambda: voteCast(root,frame1,"ss",client_socket)).grid(row = 5,column = 1)
    ...
    Radiobutton(frame1, text = "Jishithaya\n\n(BE-CSE 3yr) ", variable = vote, value = "nota", indicator = 0, height = 4, width=15, command = lambda: voteCast(root,frame1,"nota",client_socket)).grid(row = 6,column = 1)
